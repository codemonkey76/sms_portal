<x-jet-form-section submit="editCustomer">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="name" type="text" class="mt-1 block w-full" wire:model.lazy="customer.name" autocomplete="name" />
            <x-jet-input-error for="customer.name" class="mt-2" />
        </div>

        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="senderId" value="{{ __('Sender ID') }}" />
            <x-jet-input id="senderId" type="text" class="mt-1 block w-full" wire:model.lazy="customer.senderId" autocomplete="senderId" />
            <x-jet-input-error for="customer.senderId" class="mt-2" />
        </div>
    </x-slot>
