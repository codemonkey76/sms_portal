<x-jet-form-section submit="createMessage">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            ...
            <div class="flex space-x-3">
                <div class="flex space-x-1">
                    <x-input type="radio" id="type_single" name="message_type" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500" wire:model.live="message_type" value="single" />
                    <x-label for="message_type" class="ml-3" value="{{ __('Single Recipient') }}" />
                </div>
                <div class="flex space-x-1">
                    <x-input type="radio" id="type_multiple" name="message_type" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500" wire:model.live="message_type" value="multiple" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="recipient" type="text" class="mt-1 block w-full" wire:model.defer="recipient" autocomplete="recipient" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <div class="flex space-x-2">
                <select id="recipient_list" name="recipient_list" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md" wire:model="contactList">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <div class="flex space-x-2">
                <select id="location" name="location" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md" wire:model="selectedTemplate">
