                ...
                <div class="p-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 w-0 flex-1 pt-0.5">
                            <p x-text="message" class="text-sm leading-5 font-medium text-slate-900"></p>
                        </div>
                        <div class="ml-4 shrink-0 flex">
                            <button @click="remove(message)" class="inline-flex text-slate-400 focus:outline-none focus:text-slate-500 transition ease-in-out duration-150">
